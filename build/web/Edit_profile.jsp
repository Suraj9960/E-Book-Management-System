...
<html>
    ...
    <body>
        ...
        <div class="wrapper" style="border:1px solid black;">
            ...
            <form class="p-3 mt-3" action="Edit_profileServlet" method="Post">
                <input type="hidden" name="id" required="required"  value="${userobj.id}">
                <div class="form-field d-flex align-items-center">
                    <span class="far fa-user"></span>
                    <input type="text" name="Name" id="Name" placeholder="Enter Name Here" required="required" style="font-size:13px;color:red;" value="${userobj.name}">
                </div>
                <div class="form-field d-flex align-items-center">
                    <span class="fa-solid fa-envelope"></span>
                    <input type="email" name="emailId" id="emailId" placeholder="Enter Email Id Here" required="required" style="font-size:13px;color:red;"value="${userobj.email}">
                </div>
                <div class="form-field d-flex align-items-center">
                    <span class="fa-solid fa-phone"></span>
                    <input type="Number" name="PhNo" id="PhNo" placeholder="Phone Number" required="required" style="font-size:13px;color:red;"value="${userobj.phone}">
                </div>
                <div class="form-field d-flex align-items-center">
